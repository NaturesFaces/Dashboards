...
path = 'C:/Users/Gabri/Documents/Python/Coursera IBM/Data Visualization/auto.csv'
auto_data =  pd.read_csv(path)
     ...
     html.Div([
                   # First inner divsion for  adding dropdown helper text for Selected Drive wheels
                    ...
                    #Second Inner division for adding 2 inner divisions for 2 output graphs 
                      ...
                      dcc.Dropdown(
                            id='demo-dropdown',
                        options=[{'label': i, 'value': i} for i in auto_data['drive-wheels'].unique()], value = 'rwd'
        ),
                    #Second Inner division for adding 2 inner divisions for 2 output graphs 
